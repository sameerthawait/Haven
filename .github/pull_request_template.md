...
- [ ] I searched [open issues](https://github.com/your-org/haven/issues) and [open PRs](https://github.com/your-org/haven/pulls) — this is not a duplicate.
- [ ] This PR targets `dev`
...
- [ ] **Style match**: the change uses Haven's existing visual language. Specifically:
