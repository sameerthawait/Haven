"""scripts/_lib/cli.py — shared scaffolding for the `haven-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("haven-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/haven-foo`
...
VERSION = "0.1.0"  # bumped centrally; every haven-* CLI reports this
