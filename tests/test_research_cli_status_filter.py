"""`haven-research list --status complete` was returning nothing.
...
Part of #2122 (haven-* CLI list/search bugs).
"""
...
def _load_cli():
    path = ROOT / "scripts" / "haven-research"
    loader = importlib.machinery.SourceFileLoader("haven_research_cli", str(path))
