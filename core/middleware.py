...
INTERNAL_TOOL_TOKEN = os.environ.get("HAVEN_INTERNAL_TOKEN") or secrets.token_hex(32)
INTERNAL_TOOL_HEADER = "X-Haven-Internal-Token"
...
def require_admin(request: Request):
    ...
    # (a) header-direct (caller set X-Haven-Internal-Token), or
