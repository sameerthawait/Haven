...
const EMAIL_DOC_SPLIT_WIDTH_KEY = 'haven-email-doc-split-width';
const EDGE_DOCK_WIDTH_KEY_PREFIX = 'haven-edge-dock-width';
...
(function _initEdgeDockResizeHandles() {
  ...
  window.addEventListener('haven:modal-opened', _positionEdgeDockResizeHandles);
  _positionEdgeDockResizeHandles();
})();
