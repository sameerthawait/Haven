...
function initMermaid() {
  if (!window.mermaid || window.__havenMermaidReady) return;
  window.mermaid.initialize({ startOnLoad: false, theme: 'dark', securityLevel: 'loose' });
  window.__havenMermaidReady = true;
}
window.havenInitMermaid = initMermaid;
initMermaid();
...
const THINK_EXPANDED_KEY = 'haven-thinking-expanded';
