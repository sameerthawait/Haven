...
const _COST_KEY = 'haven-session-cost';
...
const _ACTION_RECENTS_KEY = 'haven-msg-actions-recent';
 ...
 */
const _USER_ACTION_RECENTS_KEY = 'haven-user-actions-recent';
...
export function addMessage(role, content, modelName, metadata) {
  try {
    ...
    var _roleText = role === 'user' ? 'You' : (isSlash || isCompacted) ? 'Haven' : modelRouteLabel(replyModels.requestedModel, resolvedModel);
