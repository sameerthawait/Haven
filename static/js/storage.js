...
export const KEYS = {
  ...
  MODELS_EXPANDED: 'haven-model-expanded',
  MODEL_ENDPOINTS: 'haven-model-endpoints',
  MODEL_SELECTED: 'haven-selected-model',
  SORT_ORDER: 'haven-sessions-sort',
  CHAT_SEARCH_SCOPE: 'haven-search-scope',
  INCOGNITO: 'haven-incognito',
  RAG_ACTIVE: 'haven-rag-active',
  MCP_ACTIVE: 'haven-mcp-active',
  SECTION_ORDER: 'sidebar-section-order',
  ADMIN_LAST_TAB: 'admin-last-tab',
  DENSITY: 'haven-density',
