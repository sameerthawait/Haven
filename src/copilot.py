...
COPILOT_USER_AGENT = os.environ.get(
    "HAVEN_COPILOT_USER_AGENT", "Haven/1.0"
)
COPILOT_INTEGRATION_ID = os.environ.get(
    "HAVEN_COPILOT_INTEGRATION_ID", "vscode-chat"
)
COPILOT_EDITOR_VERSION = os.environ.get(
    "HAVEN_COPILOT_EDITOR_VERSION", "Haven/1.0"
)
